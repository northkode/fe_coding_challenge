...
1. Separate the `starter-code` from the rest of this project and rename it to something meaningful for you. Initialize the codebase as a public repository on [GitHub](https://github.com/).
...
Please checkout this repo and use your own github to develop on. Then, just let me know when you are done, and I will check out your github source that you push up and run it locally to test it.
